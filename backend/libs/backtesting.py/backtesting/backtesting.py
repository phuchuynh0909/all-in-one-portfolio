...
class Strategy(metaclass=ABCMeta):
    ...
    def I(self,  # noqa: E743
          ...
          legends=None, histogramms=None, color_by=None, color_above=None, color_below=None,
          **kwargs) -> np.ndarray:
        """
        ...
        value = _Indicator(value, name=name, plot=plot, overlay=overlay,
                           color=color, scatter=scatter, legends=legends, histogram=histogram,
                           histogramms=histogramms, color_by=color_by,
                           color_above=color_above, color_below=color_below,
